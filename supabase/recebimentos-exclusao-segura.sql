-- AgroFlow - exclusao segura de recebimentos no modulo Balancas.
-- Nao apaga portaria, fornecedores, produtos, balancas ou laboratorios.
-- Corrige auditoria para nao manter FK contra recebimento excluido.
