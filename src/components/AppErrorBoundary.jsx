    ...
    return (
      <main className="grid min-h-screen place-items-center bg-slate-100 p-6 text-slate-900">
        <section className="w-full max-w-lg rounded-lg border border-slate-200 bg-white p-7 text-center shadow-lg">
          ...
          <h1 className="mt-5 text-2xl font-extrabold">Nao foi possivel carregar esta tela</h1>
          <p className="mt-3 text-sm leading-6 text-slate-600">
            Seus dados permanecem salvos. Atualize o sistema para carregar novamente a versao estavel.
          </p>
          <button
            type="button"
